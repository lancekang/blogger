...
export async function GET() {
  // 2026년 최신 IT/테크 트렌드 기반 풍부한 키워드 풀 (카테고리별 10개)
  const tabletMobilePool = [
    "2026년 가성비 8인치 안드로이드 태블릿 비교 추천",
  ...
  const wearableTechPool = [
    "2026년 건강 측정용 스마트 링(Smart Ring) 브랜드 비교",
    "10만원 이하 가성비 스마트워치 핵심 기능 비교",
    "갤럭시 워치 9세대 실시간 혈당 측정 기능 팩트 체크",
    "애플워치 SE 3세대 2026년 가성비 입문 추천",
